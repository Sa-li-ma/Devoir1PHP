...
<body>
    ...
    <section class="corps">
       <h1>Exercice 12 :</h1>
       <p>Dans cet exercice nous afficherons vos informations dans un tableau <br>
            La génération du tableau est gérée par un fichier php externe nommé "Exo12.php" <br>
    </p>
       
       <form action="Exercice12.php" method ="post">
       ...
       <?php  include 'Exo12.php';?> <!--Inclusion d'un fichier php eterme -->
