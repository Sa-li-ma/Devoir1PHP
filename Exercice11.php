...
<body>
    ...
    <section class="corps">
        <h1>Exercice 11 :</h1>
        <p>
            Ici nous parcourons les tableaux des exercices 8 et 9 avec la boucle "while"<br>
        </p>
        NB : Tableau9 avec foreach
       <?php 
            $tab8 = [
            ...
            foreach($tab8 as $nom => $infos){
                echo "Les informations sur $nom sont : <br> ";
                $i = 0;
                while($i <= 2){
                    echo "- $infos[$i] <br> ";
                    $i++;
