...
<body>
    ...
    <section class="corps">
        <h1>Exercice 8 :</h1>
        <p>Nous allons vous afficher un triangle en fonction de l'entier que <br>
            vous allez entrer. A vous de jouer !
        </p>
        <form action="" method="post">
            <label for="">Choisissez un entier positif :</label> <br>
